/** Python identifier rules and small rendering helpers shared by the emitter modules. */

/** Text every generated module's docstring carries (oagen prepends `fileHeader()` as a comment). */
export const HEADER_DOC = 'Auto-generated by oagen from the OpenAPI spec; do not edit by hand.';

/**
 * A generated file, always overwritten: generating into an existing output
 * directory merges `__init__.py` files additively by default, so emitter
 * changes would silently not appear.
 */
