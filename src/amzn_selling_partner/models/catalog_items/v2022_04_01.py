"""Models for catalog_items v2022_04_01 (Selling Partner API for Catalog Items).
...
CatalogIdentifiersType: TypeAlias = Literal["ASIN", "EAN", "GTIN", "ISBN", "JAN", "MINSAN", "SKU", "UPC"]
CatalogIncludedData: TypeAlias = Literal[
    "attributes",
    "classifications",
    "dimensions",
    "identifiers",
...
ItemSummaryByMarketplaceItemClassification: TypeAlias = Literal["BASE_PRODUCT", "OTHER", "PRODUCT_BUNDLE", "VARIATION_PARENT"]
