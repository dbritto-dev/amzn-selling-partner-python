...
class AsyncOrders:
    ...
    async def _get_purchase_orders_response(
    ...
    async def get_purchase_orders(
        ...
        while True:
            response = await self._get_purchase_orders_response(query=current_query)
    ...
    async def get_purchase_order(
        ...
        response = await self._get_purchase_order_response(purchase_order_number)
...
class AsyncOrdersWithRawResponse:
    ...
    async def get_purchase_orders(
        ...
        return await self._orders._get_purchase_orders_response(query=query)

    async def get_purchase_order(self, purchase_order_number: str) -> httpx2.Response:
        return await self._orders._get_purchase_order_response(purchase_order_number)
